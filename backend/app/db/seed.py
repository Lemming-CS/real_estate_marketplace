...
def seed_demo_data() -> None:
    ...
    with session_scope() as session:
        ...
        rent_apartment_listing = get_or_create_listing(
            ...
            legacy_titles=("2-комнатная квартира рядом с площадью Ала-Тоо",),
            description="Bright furnished apartment with a renovated kitchen, balcony, and fast internet. Suitable for a long-term rental.",
            ...
            address_text="105 Chuy Avenue, Bishkek",
        ...
        sale_house_listing = get_or_create_listing(
            ...
            legacy_titles=("Семейный дом с садом в Кок-Жаре",),
            description="Spacious detached house with a private yard, updated heating, and covered parking. Ready for sale.",
        ...
        reported_apartment_listing = get_or_create_listing(
            ...
            legacy_titles=("1-комнатная квартира по цене ниже рынка",),
            description="Compact apartment listed for an urgent sale. A user reported the suspiciously low price and incomplete description.",
            purpose=ListingPurpose.SALE,
            property_type=PropertyType.APARTMENT,
        ...
        draft_house_listing = get_or_create_listing(
            ...
            legacy_titles=("Черновик таунхауса в аренду в Асанбае",),
            description="Draft property waiting for final photos and owner confirmation before publication.",
            purpose=ListingPurpose.RENT,
            property_type=PropertyType.HOUSE,
        ...
        suspended_listing = get_or_create_listing(
            ...
            legacy_titles=("Квартира продавца с приостановленным аккаунтом",),
            description="This listing belongs to a seller with a suspended account and should remain hidden from public discovery.",
            purpose=ListingPurpose.RENT,
            property_type=PropertyType.APARTMENT,
            ...
            total_floors=9,
            furnished=True,
            moderation_note="Seller account suspended after repeated policy-violation reports.",
        )
